...
<section class="feature is-compact"><div class="wrap feature-inner"><div class="feature-copy"><span class="hero-kicker">ABOUT HYUNNONG FOOD LAB</span><h1>뜨거운 물 3분,<br>유기농쌀 누룽지</h1><p>친환경 농자재 기업 현농과 농업 경영컨설팅 기업 현농경영연구소가 함께 세운 식품 전문 회사입니다.</p><div class="hero-actions"><a class="button" href="/products/barunssal/">바른쌀 누룽지 보기 <span aria-hidden="true">→</span></a></div></div></div><figure class="feature-photo">${media('about-hyunnong.jpg','현농푸드랩 본사 사옥 전경','',true)}</figure></section>
