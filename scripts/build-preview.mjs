...
// M1 히어로 — C-HERO
const mainHero = () => `<section class="feature is-compact"><div class="wrap feature-inner"><div class="feature-copy"><span class="hero-kicker">HYUNNONG FOOD LAB</span><span class="category-label is-static">바른쌀 누룽지</span><h1>뜨거운 물 3분,<br>유기농쌀 누룽지</h1><p>유기가공식품 인증까지 받은 쌀로 만들었습니다. 쌀 품종과 배합비까지 공개합니다.</p><div class="hero-actions">${storeCta('스마트스토어에서 구매')}<a class="text-link" href="/products/barunssal/">바른쌀 누룽지 자세히 보기 <span aria-hidden="true">→</span></a></div></div></div><figure class="feature-photo">${media('hero-pour.jpg','흰 그릇에 담긴 바른쌀 즉석 누룽지에 뜨거운 물을 붓는 모습','',true)}</figure></section>`;
...
<section class="feature is-compact"><div class="wrap feature-inner"><div class="feature-copy"><span class="hero-kicker">BARUNSSAL NURUNGJI</span><span class="category-label is-static">즉석조리식품</span><h1>뜨거운 물 3분,<br>유기농쌀 누룽지</h1><p>국산 유기농쌀 100% <span aria-hidden="true">·</span> HACCP <span aria-hidden="true">·</span> 실온 12개월 <span aria-hidden="true">·</span> 한 봉 40g 152kcal</p><div class="hero-actions">${storeCta('스마트스토어에서 구매')}<a class="text-link" href="#faq">자주 묻는 질문 보기 <span aria-hidden="true">→</span></a></div></div></div><figure class="feature-photo">${media('product-main.jpg','바른쌀 즉석 누룽지 단상자와 개별 포장 파우치','',true)}</figure></section>
...
<section class="feature is-compact is-long-title"><div class="wrap feature-inner"><div class="feature-copy"><span class="hero-kicker">ABOUT HYUNNONG FOOD LAB</span><h1>농업을 잘 아는 회사가<br>만든 식품</h1><p>친환경 농자재 기업 현농과 농업 경영컨설팅 기업 현농경영연구소가 함께 세운 식품 전문 회사입니다.</p><div class="hero-actions"><a class="button" href="/products/barunssal/">바른쌀 누룽지 보기 <span aria-hidden="true">→</span></a></div></div></div><figure class="feature-photo">${media('about-hyunnong.jpg','현농푸드랩 본사 사옥 전경','',true)}</figure></section>
...
<section class="brand-feature"><div class="wrap brand-feature-inner"><figure>${media('product-main.jpg','바른쌀 즉석 누룽지 단상자와 개별 포장 파우치')}</figure><div class="brand-feature-copy"><span class="eyebrow">FIRST PRODUCT</span><h2>현농푸드랩의 첫 제품,<br>바른쌀 즉석 누룽지</h2><p>국산 유기농쌀 100%. 뜨거운 물 붓고 3분이면 완성됩니다.</p><dl class="brand-facts"><div><dt>한 봉</dt><dd>40g</dd></div><div><dt>열량</dt><dd>152kcal</dd></div><div><dt>원료</dt><dd>국산 유기농쌀</dd></div></dl>${storeCta('스마트스토어에서 구매')}</div></div></section>
  ...
  title:'현농푸드랩 소개 | 농업을 잘 아는 회사가 만든 식품',
  description:'농업을 잘 아는 회사가 만든 식품. 친환경 농자재 기업 현농과 농업 경영컨설팅 기업 현농경영연구소가 함께 세운 식품 전문 회사, 현농푸드랩을 소개합니다.',
  jsonLd:[organizationLd, {'@context':'https://schema.org','@type':'AboutPage',name:'현농푸드랩 소개',description:'농업을 잘 아는 회사가 만든 식품. 친환경 농자재 기업 현농과 농업 경영컨설팅 기업 현농경영연구소가 함께 세운 식품 전문 회사, 현농푸드랩을 소개합니다.'}],
});
